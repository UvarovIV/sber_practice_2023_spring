...
const addToCart = (userId, productId, dispatch) => {
    ...
    console.log(`${API_URL}/${userId}/product/${productId}`, {amount: 1}, {headers: authHeader()})

    return axios.post(`${API_URL}/${userId}/product/${productId}`, {amount: 1}, {headers: authHeader()}).then(
        () => {
